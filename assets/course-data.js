...
export const chapters = [
  {
    ...
    intro: "머신러닝을 바로 모델 코드나 라이브러리 사용법으로 시작하면, 이후의 선형대수와 최적화가 왜 필요한지 흐려집니다. 이 장에서는 데이터, 라벨, 가설, 손실함수, 결정경계를 하나의 문제 설정으로 묶어 이후 모든 장에서 사용할 공통 언어를 만듭니다.",
    introPoints: [
      "입력 공간과 특성 공간을 구분해야 모델이 실제로 무엇을 보고 판단하는지 말할 수 있습니다.",
  ...
  },
  {
    ...
    intro: "좋은 모델은 단지 맞고 틀리는 분류 결과만 내는 것이 아니라, 의사결정에 쓸 수 있는 확률을 제공해야 합니다. 이 장에서는 예측 확률을 비용 구조, 베이즈 위험, 임계값, calibration과 연결해 실제 판단 기준으로 바꾸는 방법을 배웁니다.",
    introPoints: [
