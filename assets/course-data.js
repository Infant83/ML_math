...
export const coreTakeaways = [
  {
    number: "01",
    title: "데이터는 공간에 놓인다",
    body: "벡터, 행렬, 내적, 거리, 좌표 변환은 모델이 데이터를 읽는 기본 단위입니다. 선형대수는 숫자 배열을 데이터 공간의 위치와 방향으로 해석하게 해 줍니다."
  },
  {
    number: "02",
    title: "학습은 기준을 낮추는 과정이다",
    body: "손실함수는 모델 선택의 기준이고, 그래디언트와 제약 최적화는 그 기준을 낮추는 계산 절차입니다. 학습률, 곡률, 제약 조건은 이 과정의 안정성을 설명합니다."
  },
  {
    number: "03",
    title: "판별모델은 경계와 확률을 만든다",
    body: "선형회귀와 로지스틱 회귀는 점수, 결정경계, 예측 확률, 평가 지표가 어떻게 이어지는지 보여 주는 기준 사례입니다."
  },
  {
    number: "04",
    title: "확률은 예측을 해석한다",
    body: "우도, 베이즈 정리, 엔트로피, KL divergence, calibration은 예측값을 불확실성과 의사결정의 언어로 바꿉니다."
  }
];
