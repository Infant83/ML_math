export const routeStages = [
  {
    number: "1",
    title: "문제 설정",
    body: "데이터, 라벨, 가설, 손실함수, 모델 계열의 자리."
  },
  {
    number: "2",
    title: "판별모델 기반",
    body: "벡터 공간, 결정경계, 그래디언트, 제약 최적화."
  },
  {
    number: "3",
    title: "생성모델 기반",
    body: "확률분포, 우도, 베이즈 갱신, 엔트로피와 KL."
  },
  {
    number: "4",
    title: "모델 해석",
    body: "평가 지표, calibration, 비용 기반 의사결정."
  }
];

export const coreTakeaways = [
  {
    number: "01",
    title: "판별모델 수학",
    body: "벡터와 행렬로 특성 공간을 만들고, 결정경계, 손실함수, 그래디언트, 정규화, 평가 지표로 예측 규칙을 다룹니다."
  },
  {
    number: "02",
    title: "생성모델 수학",
    body: "확률분포와 조건부 확률에서 출발해 우도, 베이즈 갱신, 엔트로피, KL divergence, 샘플링으로 데이터 생성 구조를 다룹니다."
  }
];
...
export const chapters = [
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch01.webp?v=20260525-twomodelmap",
      alt: "특성 벡터, 결정경계, 손실 표면이 하나의 학습 문제로 이어지는 강의노트형 그림",
      caption: "데이터 표현에서 손실 최소화까지 이어지는 머신러닝 문제 설정"
    },
    introTitle: "머신러닝을 수학 문제로 바꾸기",
    intro: "모델 코드나 라이브러리 사용법으로 바로 시작할 수도 있습니다. 이 장에서는 그 전에 데이터, 라벨, 가설, 손실함수, 결정경계를 하나의 문제 설정으로 놓고, 이어지는 선형대수와 최적화가 맡는 역할을 함께 다룹니다.",
    introPoints: [
      "입력 공간과 특성 공간의 구분은 모델이 실제로 어떤 정보를 쓰는지 보여 줍니다.",
      "결정경계는 분류 모델의 예측을 기하적으로 이해하게 해 줍니다.",
      "손실함수는 좋은 모델을 고르는 기준이며, 뒤의 최적화 장으로 자연스럽게 이어집니다."
    ],
    ...
    sections: [
      ...
      {
        heading: "판별적 관점",
        body: "판별모형은 데이터가 어떻게 생성되었는지를 모두 설명하려 하기보다, 주어진 x에서 y를 판단하는 경계나 조건부 확률을 직접 학습합니다. 특성 공간, 결정경계, 손실함수의 관계가 이 장의 중심입니다."
      }
    ],
    delivery: [
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch02.webp?v=20260525-twomodelmap",
      alt: "벡터, 행렬 변환, 고유축, 저랭크 구조가 연결된 선형대수 강의노트 그림",
      caption: "벡터와 행렬을 데이터 공간의 위치, 방향, 변환으로 읽는 관점"
    },
    introTitle: "벡터와 행렬은 데이터의 좌표계",
    intro: "머신러닝 모델은 데이터의 의미를 직접 보지 않고 숫자 벡터와 행렬 연산을 봅니다. 선형대수를 배우는 이유는 이 숫자들이 공간 안에서 어떤 위치, 방향, 거리, 변환을 뜻하는지 해석하기 위해서입니다.",
    introPoints: [
      "내적과 norm은 유사도, 거리, 선형 점수의 기본 계산이 됩니다.",
      "행렬은 숫자 표가 아니라 데이터를 다른 좌표계로 옮기는 변환으로 읽을 수 있습니다.",
      "고유분해와 SVD는 PCA와 저랭크 근사의 핵심 도구로 다시 등장합니다."
    ],
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch03.webp?v=20260525-twomodelmap",
      alt: "손실 표면의 등고선, 그래디언트 경로, 곡률 보정이 함께 보이는 최적화 강의노트 그림",
      caption: "학습을 손실 표면 위에서 파라미터가 이동하는 과정으로 이해하기"
    },
    introTitle: "학습은 손실 표면 위의 이동",
    intro: "모델을 학습한다는 말은 대부분 손실함수를 줄이도록 파라미터를 반복해서 바꾼다는 뜻입니다. 미분과 최적화는 그 이동 방향과 보폭을 정하는 언어이며, 그래디언트와 곡률은 학습이 안정적으로 수렴하는지 판단하는 기준이 됩니다.",
    introPoints: [
      "그래디언트는 현재 위치에서 손실이 가장 빠르게 변하는 방향을 알려 줍니다.",
      "학습률은 수렴, 진동, 발산을 가르는 실전적인 조절 변수입니다.",
      "헤시안과 조건수는 손실 표면의 모양이 학습 난이도에 미치는 영향을 설명합니다."
    ],
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch04.webp?v=20260525-twomodelmap",
      alt: "볼록 feasible set, 등고선, 경계 접점, 투영 업데이트가 보이는 제약 최적화 그림",
      caption: "제약 조건 안에서 목적함수의 좋은 해를 찾는 기하적 관점"
    },
    introTitle: "좋은 해는 제약 안에서 결정된다",
    intro: "실제 모델 학습은 아무 값이나 고르는 문제가 아닙니다. 파라미터 크기, 확률 simplex, margin, nonnegative 조건처럼 해가 놓일 수 있는 영역이 있고, 제약 최적화는 그 영역 안에서 가장 합리적인 해를 찾는 방법을 제공합니다.",
    introPoints: [
      "라그랑지안은 목적함수와 제약 조건을 하나의 계산 대상으로 묶습니다.",
      "KKT 조건은 제약이 있는 해가 왜 그 지점에서 멈추는지 설명합니다.",
      "볼록성은 지역 최적해를 전역 최적해로 믿을 수 있게 해 주는 중요한 조건입니다."
    ],
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch05.webp?v=20260525-twomodelmap",
      alt: "회귀선, 로지스틱 곡선, 선형 결정경계가 나란히 배치된 선형모형 강의노트 그림",
      caption: "선형 점수가 회귀, 확률 예측, 분류 결정으로 바뀌는 흐름"
    },
    introTitle: "선형모형은 판별모델의 기준선",
    intro: "선형모형은 단순해서 넘어갈 대상이 아니라, 손실함수, 정규화, 확률 출력, 결정경계, 평가 지표를 가장 투명하게 보여 주는 기준 모델입니다. 이 장을 이해하면 복잡한 모델을 볼 때도 무엇이 추가되었고 무엇이 그대로 남았는지 구분할 수 있습니다.",
    introPoints: [
      "선형회귀는 오차를 줄이는 목적함수와 정규화의 의미를 명확하게 보여 줍니다.",
      "로지스틱 회귀는 선형 점수를 확률과 결정경계로 연결합니다.",
      "평가지표는 모델 점수를 실제 의사결정 기준으로 바꾸는 첫 단계입니다."
    ],
    ...
    sections: [
      {
        heading: "선형모형은 기준선이다",
        body: "선형모형은 복잡한 모델의 반대편에 있는 단순한 도구가 아니라, 손실, 정규화, 평가, 해석을 모두 보여 주는 기준 사례입니다. 이후 신경망도 국소적으로는 선형 변환과 비선형 활성화의 조합으로 읽을 수 있습니다."
      },
      {
        heading: "회귀에서 분류로",
        body: "선형회귀는 연속값을 예측하고, 로지스틱 회귀는 선형 점수를 확률로 변환합니다. 이 변환을 거치면 결정경계와 예측 확률이 같은 모델 안에 함께 놓입니다."
      }
    ],
    delivery: [
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch06.webp?v=20260525-twomodelmap",
      alt: "데이터 구름이 주성분 평면으로 투영되고 저랭크 구조로 압축되는 차원축소 그림",
      caption: "고차원 데이터에서 분산이 큰 방향과 낮은 차원 구조를 찾는 과정"
    },
    introTitle: "차원축소는 구조를 보는 렌즈",
    intro: "데이터의 차원이 높아질수록 거리, 시각화, 노이즈, 계산 비용이 모두 어려워집니다. PCA와 SVD를 배우는 이유는 데이터를 단순히 작게 만들기 위해서가 아니라, 데이터가 실제로 어느 방향과 부분공간에 놓여 있는지 보기 위해서입니다.",
    introPoints: [
      "공분산 행렬은 특성들이 함께 변하는 방향을 요약합니다.",
      "PCA는 분산이 큰 축으로 투영해 데이터의 주된 구조를 드러냅니다.",
      "차원축소는 예측 성능의 증명이 아니라 구조 해석과 시각화의 도구입니다."
    ],
    ...
    sections: [
      {
        heading: "차원축소의 목적",
        body: "차원축소는 시각화, 노이즈 제거, 압축, 구조 탐색의 도구입니다. 지도학습의 성능 개선만을 목적으로 하지 않으며, 분산 보존과 예측력 보존은 서로 다른 기준입니다."
      },
      {
        heading: "PCA의 해석",
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch07.webp?v=20260525-twomodelmap",
      alt: "계산 그래프의 순전파와 역전파 화살표, 미니배치 점, 최적화 경로가 보이는 신경망 그림",
      caption: "신경망 학습을 연쇄법칙과 확률적 최적화의 결합으로 읽기"
    },
    introTitle: "역전파는 연쇄법칙의 계산 조직",
    intro: "신경망은 새로운 수학으로 갑자기 등장하는 것이 아니라, 선형변환과 비선형 함수가 여러 번 합성된 계산 그래프입니다. 이 장에서는 순전파와 역전파를 통해 미분값이 어떻게 재사용되고, SGD와 Adam이 그 기울기로 파라미터를 갱신하는지 봅니다.",
    introPoints: [
      "계산 그래프는 복합함수의 값과 기울기 흐름을 분해해서 보여 줍니다.",
      "역전파는 연쇄법칙을 효율적으로 적용하는 계산 절차입니다.",
      "미니배치와 Adam은 큰 데이터와 불안정한 그래디언트를 다루기 위한 최적화 장치입니다."
    ],
    ...
    nextSteps: [
      ...
      "Adam은 bias correction 공식보다, 모멘트 추정이 필요한 이유와 사용 시 주의할 상황을 중심으로 읽습니다.",
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l1-ch08.webp?v=20260525-twomodelmap",
    ...
    introPoints: [
      "전처리와 train/test split은 모델 평가의 신뢰도를 결정합니다.",
      "로지스틱 회귀의 예측 확률은 임계값과 ROC 해석으로 이어집니다.",
      "PCA 시각화는 모델 성능을 증명하기보다 데이터 구조를 보조적으로 설명합니다."
    ],
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l2-ch01.webp?v=20260525-twomodelmap",
      alt: "사건 영역, 확률 트리, 사전분포에서 사후분포로 이동하는 베이즈 업데이트 그림",
      caption: "조건부 정보가 들어올 때 확률적 믿음이 갱신되는 과정"
    },
    introTitle: "확률은 관측 이후의 믿음을 바꾸는 언어",
    intro: "머신러닝의 예측은 불확실성을 다루는 일입니다. 확률과 베이즈 정리를 배우는 이유는 어떤 관측이 들어왔을 때 기존의 믿음이 어떻게 바뀌어야 하는지, 그리고 우도와 사전분포가 추정 결과에 어떤 역할을 하는지 설명하기 위해서입니다.",
    introPoints: [
      "조건부 확률은 정보가 주어진 뒤 표본공간을 다시 읽는 방식입니다.",
      "베이즈 정리는 prior, likelihood, evidence, posterior의 관계를 하나로 묶습니다.",
      "MLE와 MAP는 정규화를 확률적 추정 관점에서 다시 이해하게 해 줍니다."
    ],
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l2-ch02.webp?v=20260525-twomodelmap",
      alt: "확률 막대, 코드 길이, 엔트로피, 교차 엔트로피, KL 차이를 연결한 정보이론 그림",
      caption: "분류 손실을 평균 정보량과 분포 근사의 관점으로 해석하기"
    },
    introTitle: "손실함수를 정보량으로 다시 읽기",
    intro: "분류 모델의 cross entropy loss는 단순한 벌점처럼 보이지만, 정보이론 관점에서는 잘못된 분포로 데이터를 설명할 때 생기는 추가 코드 길이로 읽을 수 있습니다. 이 장은 엔트로피, 로그우도, KL divergence를 통해 손실함수가 왜 분포 학습의 언어인지 설명합니다.",
    introPoints: [
      "정보량은 드문 사건이 더 많은 놀라움을 준다는 직관을 수식화합니다.",
      "교차 엔트로피는 정답 분포와 모델 분포 사이의 설명 비용을 나타냅니다.",
      "KL divergence는 모델 분포가 실제 분포를 얼마나 비효율적으로 근사하는지 보여 줍니다."
    ],
    ...
    delivery: [
      ...
      "p와 q를 바꿔 KL(p||q), KL(q||p)가 달라지는 예제를 함께 비교합니다."
    ],
    nextSteps: [
  ...
  },
  {
    ...
    visual: {
      src: "assets/chapter-visuals/l2-ch03.webp?v=20260525-twomodelmap",
      alt: "확률 예측이 비용, 임계값, 위험 곡선, 보정 곡선으로 이어지는 베이즈 의사결정 그림",
      caption: "예측 확률을 비용 구조와 보정 관점에서 실제 행동으로 바꾸기"
    },
    introTitle: "확률 예측을 행동으로 바꾸기",
    intro: "좋은 모델은 맞고 틀리는 분류 결과뿐 아니라, 의사결정에 참고할 확률까지 함께 다룹니다. 이 장에서는 예측 확률을 비용 구조, 베이즈 위험, 임계값, calibration과 연결해 실제 판단 기준으로 바꾸는 흐름을 다룹니다.",
    introPoints: [
      "베이즈 위험은 가능한 행동의 비용을 사후확률로 가중해 비교합니다.",
      "오탐과 미탐의 비용이 다르면 같은 확률 모델에서도 최적 임계값이 달라집니다.",
      "calibration은 모델이 말한 확률이 실제 빈도와 맞는지를 점검합니다."
    ],
...
export const checklistItems = [
  ["문제 설정", "특성 공간, 가설, 손실함수로 지도학습 문제를 설명해 봅니다."],
  ["기하", "내적, 행렬, 고유분해, PCA가 데이터 구조 해석에 쓰이는 위치를 말로 정리합니다."],
  ["최적화", "그래디언트와 제약 조건이 모델 학습의 업데이트 규칙으로 이어지는 과정을 이해합니다."],
  ["확률/정보", "우도, 엔트로피, KL divergence와 손실함수의 연결 관계를 정리합니다."],
  ["의사결정", "예측 확률을 비용, 위험, calibration 관점에서 점검합니다."]
];
